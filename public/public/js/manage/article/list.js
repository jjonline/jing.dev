$(function () {
    ...
    $("#exec_reset").click(function () {
        ...
        $("#search_begin_date1").val("");
        $("#search_end_date1").val("");

        $("#search_begin_date2").val("");
        $("#search_end_date2").val("");
            ...
            ajax: {
                ...
                data: function (data) {
                    return $.extend({}, data, {
                        ...
                        "create_time_begin":$("#search_begin_date1").val(),
                        "create_time_end":$("#search_end_date1").val(),
                        "update_time_begin":$("#search_begin_date2").val(),
                        "update_time_end":$("#search_end_date2").val(),
                    });
                },
                /**
                 * +++++++++++++++++++++++++++++++++++++++++++
