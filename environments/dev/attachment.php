...
return [
    ...
    */
    'oss' => [
        ...
        'frontend' => [
            /*
             |--------------------------------------------------------------------------
             | 是否启用https访问协议，启用需在控制台设置https证书，有免费的
             |--------------------------------------------------------------------------
             */
            'is_ssl' => false,
            /*
    ...
    */
    'qiniu' => [
        ...
        'frontend' => [
            ...
            /*
             |--------------------------------------------------------------------------
             | 访问所用使用access_key_id，即AK
             |--------------------------------------------------------------------------
             */
            'access_key_id' => '',
            /*
             |--------------------------------------------------------------------------
             | 访问所用使用access_key_secret，即SK
             |--------------------------------------------------------------------------
             */
            'access_key_secret' => '',
        ],
    ...
    */
    'upyun' => [
         ...
         * 又拍云公共开放资源相关特性配置
         * ---
         * 即通过资源的url即可任意访问的资源，没有设置token防盗链规则的资源
         * ---
         */
        'frontend' => [
            /*
             |--------------------------------------------------------------------------
             | 是否启用https访问协议，启用则需在又拍云控制台设置https证书，有免费的
             |--------------------------------------------------------------------------
             */
            'is_ssl' => false,
            /*
             |--------------------------------------------------------------------------
             | 访问资源的域名，不得留空，不建议使用又拍云测试域名，建议绑定域名并在此填写
             | 例如：www.qn.com
             |--------------------------------------------------------------------------
             */
            'domain' => '',
            /*
             |--------------------------------------------------------------------------
             | 又拍云云存储服务名称，即传统意义上的bucket，但又拍云不叫bucket而是叫服务名称
             |--------------------------------------------------------------------------
             */
            'service_name' => '',
            /*
             |--------------------------------------------------------------------------
             | 访问所用使用操作员用户名，即传统意义上的access_key_id
             |--------------------------------------------------------------------------
             */
            'operator_name' => '',
            /*
             |--------------------------------------------------------------------------
             | 访问所使用操作员密码，即传统意义上的access_key_secret
             |--------------------------------------------------------------------------
             */
            'operator_pwd' => '',
        ],
        /**
         * 又拍云私有资源相关特性配置，即设置后token防盗链的服务
         * ---
         * 私有资源特性配置，若要访问则需要计算授权参数，在url基础上附加授权参数和过期时间方可访问到
         * ---
         */
        'safe'     => [
            ...
            /*
             |--------------------------------------------------------------------------
             | 访问所用使用操作员用户名，在操作员授权处新建生成；即传统意义上的access_key_id
             |--------------------------------------------------------------------------
             */
            'operator_name' => '',
            /*
             |--------------------------------------------------------------------------
             | 访问所使用操作员密码，在操作员授权处新建生成；即传统意义上的access_key_secret
             |--------------------------------------------------------------------------
             */
            'operator_pwd' => '',
            /*
             |--------------------------------------------------------------------------
             | token防盗链自主设置的Token密钥，在又拍云控制台自主设置并启用token防盗链
             |--------------------------------------------------------------------------
             */
            'token_key' => '',
        ],
