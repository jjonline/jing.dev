...
class ChatGroupSearch extends BaseSearch
{
    ...
    public function search(Request $request)
    {
        ...
        $query->field(['d.*','u.real_name','u.username'])
              ->group('d.id');
        ...
        if (!empty($keyword)) {
            $query->where('(d.name like :keyword1 OR d.remark like :keyword2 OR u.username like :keyword3 OR u.real_name like :keyword4)',[
                'keyword1' => '%'.$keyword.'%',
                'keyword2' => '%'.$keyword.'%',
                'keyword3' => '%'.$keyword.'%',
                'keyword4' => '%'.$keyword.'%',
